...
//        Date curDt = DateUtil.str2date(curDate);
    ...
    /**
     * 根据传入的日期时间str，与需要增加的小时数、分钟数，返回add后的时间日期
     * @param parrten
     * @param addHour
     * @param addMin
     * @return
     */
    public static String getAddDateTime(String parrten,int addHour,int addMin){
        Calendar c = Calendar.getInstance();
        c.setTime(DateUtil.str2datetime(parrten));
    ...
    public static void main(String[] args){
        String time1 = DateUtil.getCurDateTime();
        String time2 = getAddDateTime(DateUtil.getCurDateTime(), 2, 70);
        System.out.println(" compare : "+DateUtil.compareStringTime(time2,time1,"yyyy-MM-dd HH:mm:ss"));
    }
}
